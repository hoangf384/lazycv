...
== #section("Summary")
MIS student with a solid foundation in database management and business processes. Seeking a Business Analyst Intern position to learn requirements gathering and team coordination in a real-world software development environment. Strong communication and analytical skills.
...
#grid(
  ...
  column-gutter: 0.5em,
  row-gutter: 0.7em,
  [*Core Methodology*], [:], [Requirements Gathering, Business Process Mapping, Team Collaboration],
  [*Databases & SQL*], [:], [SQL (MySQL, SQL Server), Database Analysis],
  [*Data Tools*], [:], [MS Excel (Pivot Tables, Advanced Formulas, VLOOKUP), Google Sheets],
  [*Visualization*], [:], [Tableau, Looker Studio, Power BI],
  [*Programming*], [:], [Python (Pandas), R, Google Apps Script],
  [*Other Tools*], [:], [Git, Docker, English (Professional Communication & Reading - B2 CEFR)]
)
