...
#align(center)[
  ...
  #v(0em)
  #text(size: 10pt, weight: "bold", fill: gray.darken(40%))[Business Analyst Intern] \
  #v(0em)
...
Là sinh viên ngành Hệ thống thông tin quản lý, tôi định hướng phát triển sự nghiệp theo hướng Business Analyst. Với thế mạnh về giao tiếp, tư duy phân tích và kiến thức về cơ sở dữ liệu, tôi mong muốn học hỏi kinh nghiệm thực tế về thu thập yêu cầu nghiệp vụ và phối hợp cùng đội ngũ phát triển để hỗ trợ xây dựng sản phẩm tối ưu.
...
#grid(
  ...
  column-gutter: 0.5em,
  row-gutter: 0.7em,
  [*Nghiệp vụ cơ bản*], [:], [Thu thập yêu cầu, Phân tích quy trình kinh doanh (Process Mapping), Giao tiếp & Làm việc nhóm],
  [*Cơ sở dữ liệu*], [:], [SQL (MySQL, SQL Server), Phân tích dữ liệu hệ thống],
  [*Công cụ Dữ liệu*], [:], [MS Excel (Pivot Tables, Advanced Formulas, VLOOKUP), Google Sheets],
  [*Trực quan hóa*], [:], [Tableau, Looker Studio, Power BI],
  [*Lập trình*], [:], [Python (Pandas), R, Google Apps Script],
  [*Công cụ khác*], [:], [Git, Docker, Tiếng Anh (Giao tiếp & Đọc hiểu tài liệu - B2 CEFR)]
)
