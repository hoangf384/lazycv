...
#align(center)[
  ...
  #v(0em)
  #text(size: 10pt, weight: "bold", fill: gray.darken(40%))[Thực tập sinh Chi nhánh] \
  #v(0em)
...
Là sinh viên mới tốt nghiệp chuyên ngành Hệ thống thông tin quản lý, tôi định hướng phát triển sự nghiệp trong lĩnh vực Tài chính - Chứng khoán và Dịch vụ khách hàng. Với thế mạnh về kỹ năng giao tiếp tốt, tác phong chuyên nghiệp cùng phẩm chất cẩn thận, tỉ mỉ, tôi mong muốn đóng góp năng lực để hỗ trợ rà soát chứng từ giao dịch, quản lý tài khoản và hỗ trợ chăm sóc khách hàng tại Chi nhánh của Chứng khoán Phú Hưng (PHS).
...
== #section("Kinh nghiệm làm việc")
  ...
  desc: [
    - Thiết kế và chuẩn hóa hệ thống quản lý dữ liệu leads (Mini CRM) trên Google Sheets, phân bổ nguồn dữ liệu khoa học cho Sales và thực hiện phân quyền bảo mật thông tin nội bộ.
    - Rà soát dữ liệu bán hàng và xây dựng báo cáo phân tích hiệu suất định kỳ hàng tuần giúp ban quản lý giám sát tiến độ vận hành chi nhánh.
    - Hỗ trợ công tác tổ chức, quản lý tệp dữ liệu khách hàng tiềm năng và tối ưu hóa quy trình nhập liệu.
  ]
)
  ...
  desc: [
    - Hỗ trợ kiểm tra, rà soát và đối soát hơn 1.000 hồ sơ chứng từ giao dịch mỗi ngày đối chiếu với tài liệu pháp lý, đảm bảo tính hợp lệ, tuân thủ và độ chính xác đạt 99%.
    - Phân loại, đóng cuốn, sắp xếp và lưu trữ hồ sơ, sổ sách chứng từ vận hành một cách khoa học, cẩn thận để phục vụ công tác tra cứu của các phòng ban.
    - Phối hợp với cross-team để xử lý các điểm nghẽn trong quy trình nhập liệu, đảm bảo cập nhật thông tin hệ thống đúng hạn.
  ]
)
  ...
  desc: [
    - Tối ưu hóa cấu trúc metadata và bố cục cho hơn 50 trang web, hỗ trợ công tác quản trị nội dung số của công ty.
    - Hỗ trợ triển khai liên kết nội bộ, cải thiện 10% số lượt hiển thị tự nhiên của thương hiệu trên công cụ tìm kiếm.
  ]
)
...
#grid(
  ...
  column-gutter: 0.5em,
  row-gutter: 0.7em,
  [*Nghiệp vụ chi nhánh*], [:], [Kiểm tra & Rà soát chứng từ giao dịch, Chăm sóc khách hàng, Xử lý hồ sơ tài khoản],
  [*Kỹ năng bổ trợ*], [:], [Giao tiếp chuyên nghiệp, Làm việc nhóm, Giải quyết vấn đề, Tỉ mỉ & Cẩn thận],
  [*Công cụ văn phòng*], [:], [MS Excel / Google Sheets (CRM setup, Pivot Tables), Word, PowerPoint],
  [*Kỹ thuật dữ liệu*], [:], [SQL (MySQL, SQL Server), Python (Pandas), Trực quan hóa dữ liệu (Tableau, Looker Studio)],
