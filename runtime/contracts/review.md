# Review & Validation Contract (runtime/contracts/review.md)
...
* **Inputs:**
  ...
  * Application Letter: `applications/{track}/{company_name}/cover_letter.md`
* **Outputs:**
...
* **Layout & Style Audit:** Verify that formatting matches `domain/knowledge/STYLE.md` (no orphan lines, correct font usage, page budgets).
