...
== #section("Summary")
Detail-oriented and proactive MIS graduate with a strong foundation in *Business Data Science*. Eager to apply SQL query optimization, ETL processes, and dashboard development skills (Power BI, Excel) to support data collection and automate reporting workflows at iBasic. Fast learner, motivated to gain experience in retail and e-commerce models.
...
== #section("Work Experience")
  ...
  desc: [
    ...
    - Moderated, verified, and standardized metadata for over 1,500 job postings on boss.vn, resolving inconsistencies and cleansing database entries.
  ]
)
...
#grid(
  ...
  column-gutter: 0.5em,
  row-gutter: 0.7em,
  [*BI & ETL Skills*], [:], [SQL Query Optimization, ETL Processes (Extract, Transform, Load), Automated Reporting],
  [*Databases & Tools*], [:], [MySQL, BigQuery, SQL Server, Excel (Pivot Tables, Advanced Formulas, VLOOKUP)],
  [*Programming*], [:], [Python (Pandas, Polars, PySpark), R, Google Apps Script],
